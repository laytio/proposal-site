    ...
    <section id="root-cause" className="py-24 px-6 bg-white/[0.02]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative">
          <div className="absolute start-5 top-8 bottom-8 w-px bg-gradient-to-b from-emerald-500/50 via-teal-500/30 to-transparent hidden sm:block" />
              ...
              <div key={i} className="flex gap-6 group">
                ...
                <div className="flex-1 pb-4">
                  <div className="p-5 rounded-2xl bg-[#0d1426] border border-white/10 hover:border-emerald-500/30 transition-all hover:bg-[#0f1830]">
                    <p className="text-sm text-emerald-400 font-semibold mb-2">{r.whyLabel} {i + 1}:</p>
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/30">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-white font-bold mb-2">{r.findingTitle}</h4>
              <p className="text-slate-300 leading-relaxed">
                {r.findingText1}{' '}
                <span className="text-emerald-400 font-semibold">{r.findingSpan}</span>
                {r.findingText2}
              </p>
            </div>
          </div>
